...
export const PASSIVES = {
    ...
    THORNS: { id: 'thorns', name: 'Thorns', description: 'Reflect 25 % of damage taken' }, // Updated description based on recent balance
