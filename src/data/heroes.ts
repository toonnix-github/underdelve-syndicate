...
export const HERO_ROSTER: HeroTemplate[] = [
    ...
    {
        name: 'Krix', hp: 84, atk: 15, def: 9, spd: 20, role: 'DPS', imageId: 'hero_krix',
    ...
    {
        name: 'Draka', hp: 168, atk: 11, def: 21, spd: 6, role: 'TANK', imageId: 'hero_draka',
    ...
    {
        name: 'Vex', hp: 82, atk: 17, def: 7, spd: 18, role: 'DPS', imageId: 'hero_vex',
    ...
    {
        name: 'Leora', hp: 74, atk: 17, def: 6, spd: 21, role: 'DPS', imageId: 'hero_leora',
    ...
    {
        name: 'Grimm', hp: 124, atk: 12, def: 16, spd: 10, role: 'TANK', imageId: 'hero_grimm',
    ...
    {
        name: 'Lira', hp: 86, atk: 9, def: 9, spd: 18, role: 'HEALER', imageId: 'hero_lira',
    ...
    {
        name: 'Valthea', hp: 132, atk: 11, def: 17, spd: 11, role: 'TANK', imageId: 'hero_valthea',
    ...
    {
        name: 'Elara', hp: 82, atk: 8, def: 12, spd: 9, role: 'HEALER', imageId: 'hero_elara',
